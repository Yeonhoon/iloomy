			...
			<body>
				...
				<div class="body">
							...
							<table id="form" class="table align-middle">
								<tbody>
									<tr>
										...
										<td class="form-group"><input class= "form-control" type="text" id="itemsName" name="itemsName"/></td>
									</tr>
									<tr>
										<td class="list"><label for="itemsPrice">가격</label></td>
										<td class="form-group"> <input class= "form-control" type="number" id="itemsPrice" name="itemsPrice"/></td>
									</tr>
									<tr>
										<td class="list"><label for="itemsModel">모델명</label></td>
										<td class="form-group"><input class= "form-control" type="text" id="itemsModel" name="itemsModel"></td>
									</tr>
									<tr>
										<td class="list"><label for="itemsCompany">브랜드</label></td>
										<td class="form-group"><input class= "form-control" type="text" id="itemsCompany" name="itemsCompany"/></td>
									</tr>
									<tr>
										<td class="list"><label for="itemsContext">제품 설명</label></td>
										<td class="form-group"><input class= "form-control" type="text" id="itemsContext" name="itemsContext"/></td>
									</tr>
									<tr>
										<td class="list"><label for="itemsManufacture">제조사</label></td>
										<td class="form-group"><input class= "form-control" type="text" id="itemsManufacture"name="itemsManufacture"></td>
									</tr>
									<tr>
										<td class="list"><label for="itemsOrigin">원산지</label></td>
										<td class="form-group"><input class= "form-control" type="text" id="itemsOrigin" name="itemsOrigin"></td>
									</tr>
									<tr>
										<td class="list"><label for="itemsOption">제품 옵션</label></td>
										<td class="form-group"><input class= "form-control" type="text" id="itemsOption" name="itemsOption"/></td>
									</tr>
									<tr>
										<td class="list"><label for="itemsColor">제품 색상</label></td>
										<td class="form-group"><input class= "form-control" type="text" id="itemsColor" name="itemsColor"/></td>
									</tr>
									<tr>
										<td class="list"><label for="itemsStock">제품 수량</label></td>
										<td class="form-group"><input class= "form-control" type="number" id="itemsStock" name="itemsStock" /></td>
									</tr>
									<tr>
										<td class="list"><label for="itemsAttach">이미지 첨부 </label></td>
										<td class="form-group"><input type="file" id="itemsAttach" name="itemsAttach" value="이미지 첨부"/></td>
									</tr>
					...
					<div class="d-flex justify-content-center ml-3">
						<a href="javascript:saveMain()" id="savebtn" type="submit" class="btn btn-primary" style="color: white; margin-right:20px;">상세정보 입력하기</a>
